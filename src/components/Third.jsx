...
const Third = () => {
  return (
    <div className='bg-[#202229]' >
        <div className='justify-end flex'><img className='' src={mark} alt="" /></div>
        <div className=' mt-[40px] h-fit py-[190px] lg:space-x-20 bg-[#202229] text-white flex flex-col lg:flex-row items-center justify-between  lg:pl-10 lg:pr-[229px]   '>
            
            <div className='flex px-auto flex-col gap-6  lg:gap-16 items-center lg:items-start pb-28 ' data-aos="zoom-in">
            ...
            <div className='flex flex-col gap-8 lg:gap-12 items-center lg:items-start' data-aos="fade-down-left" data-aos-duration="500">
